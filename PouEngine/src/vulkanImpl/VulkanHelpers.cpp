...
{
    VulkanHelpers::transitionImageLayout(image.vkImage, 0, 1, image.mipsCount,
...
void VulkanHelpers::transitionImageLayout(VImage image, uint32_t layer, VkImageLayout oldLayout, VkImageLayout newLayout,
                                      CommandPoolName commandPoolName)
{
    VulkanHelpers::transitionImageLayout(image.vkImage, layer, 1, image.mipsCount,
                                         image.format, oldLayout, newLayout, commandPoolName);
}

void VulkanHelpers::transitionImageLayoutLayers(VImage image, uint32_t layersStart, uint32_t layersCount,
                                                VkImageLayout oldLayout, VkImageLayout newLayout,
                                                CommandPoolName commandPoolName)
{
    VulkanHelpers::transitionImageLayout(image.vkImage, layersStart, layersCount, image.mipsCount,
                                         image.format, oldLayout, newLayout, commandPoolName);
}

void VulkanHelpers::transitionImageLayout(VkImage image, uint32_t layerStart, uint32_t layersCount, uint32_t mipsCount,
                                          ...
                                          CommandPoolName commandPoolName)
{
    ...
    barrier.subresourceRange.baseArrayLayer = layerStart;
